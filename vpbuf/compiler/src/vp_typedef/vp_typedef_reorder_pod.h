...
struct vp_typedef_reorder_pod : public vp_typedef
{
   PodItems pod_items;
   ...
   void gen_cpp_utils(ofstream &, int, TypeMap &, TarLang &);
   void gen_py_utils(ofstream &, int, TypeMap &, TarLang &);
   void gen_js_utils(ofstream &, int, TypeMap &, TarLang &);
